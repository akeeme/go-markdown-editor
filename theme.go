...
func (m *myTheme) Color(n fyne.ThemeColorName, v fyne.ThemeVariant) color.Color {
	...
	case theme.ColorNamePrimary:
		if v == theme.VariantLight {
			return &color.NRGBA{R: 0xFF, G: 0xFF, B: 0xFF, A: 0xFF} // White color for light variant
		}
		return &color.NRGBA{R: 0xFF, G: 0xFF, B: 0xFF, A: 0xFF} // White color for dark variant
